...
import { detailExpand, detailExpandArrow } from '../../../shared/animations/animations';
...
import { DELETE_GUIDELINE_CONFIRMATION, confirmationDialogConfig } from '../../../constants';
...
export class GuidelineListComponent implements OnInit, OnDestroy {
  ...
  columnsToDisplay = ['arrow', 'cancerType', 'version', 'modified', 'creator', 'created', 'actions'];
