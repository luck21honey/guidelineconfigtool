...
export class GraphComponent implements AfterViewInit, OnChanges {
  ...
  commonActionsOnAnyNode(
    ...
    let foHeight = textBox.text._groups[0][0].getBoundingClientRect().height;
    console.log(textBox.text._groups[0][0]);
    ...
    downArrowImg.attr('y', foHeight + downOffset);   // added 20 to place the icon over the border of the rectangle => delete icon placement
    if (freeFormImg !== null) {
      freeFormImg.attr('y', foHeight + downOffset); // added 20 to place the icon over the border of the rectangle => delete icon placement
    }
  }
