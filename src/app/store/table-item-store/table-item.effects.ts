  ...
  createStartingPoint$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((payload: TableItemCreatePayload) =>
        this.tableItemService.create(payload.tableItem)
          .pipe(
            map(tableItem => TableItemActions.createSucceeded({ tableItem })),
  ...
  updateStartingPoint$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((payload: UpdatePayload<TableItem>) =>
        this.tableItemService.update(payload.changes)
          .pipe(
            map(tableItem => TableItemActions.updateSucceeded({ id: payload.id, changes: tableItem })),
