...
export const createNodeA = (): Node => {
  return {
    ...
    version: 0,
    content: CONTENT_A,
    outgoingNodes: [{ childNodeId: ID_2, step: false }, { childNodeId: ID_3, step: false }, { childNodeId: ID_3, step: false }],
    footnotes: null,
    section: null,
    index: INDEX_0,
    guidelineId: null
...
export const createNodeB = (): Node => {
  return {
    ...
    version: 0,
    content: CONTENT_B,
    outgoingNodes: [{ childNodeId: ID_3, step: false }, { childNodeId: ID_3, step: false }],
    footnotes: null,
    section: null,
    index: INDEX_1,
    guidelineId: null
